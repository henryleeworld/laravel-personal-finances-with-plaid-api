    ...
    <div class="container mx-auto px-6 md:px-0">
        <div class="flex items-center justify-between w-full">
            ...
            <div class="flex-1 text-left text-white">
                <a class="nav-link underline mr-4" href="/accounts">{{ trans('frontend.accounts.title') }}</a>
            </div>
            @endauth
            ...
            @else
                <div class="flex-1 flex justify-end items-center">
                    ...
                    <a class="nav-link text-white underline ml-4" href="/settings">{{ trans('frontend.settings.title') }}</a>
